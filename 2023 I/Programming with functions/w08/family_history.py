...
def print_death_age(people_dict):
    ...
    for person in people_dict:
        ...
        death_age = people_dict[person][DEATH_YEAR_INDEX] - people_dict[person][BIRTH_YEAR_INDEX]
...
def print_marriages(marriages_dict, people_dict):
    ...
    for marriage in marriages_dict:
        wedding_year = marriages_dict[marriage][WEDDING_YEAR_INDEX]
        husband_name = people_dict[marriages_dict[marriage][HUSBAND_KEY_INDEX]][NAME_INDEX]
        husband_wedding_age = marriages_dict[marriage][WEDDING_YEAR_INDEX] - people_dict[marriages_dict[marriage][HUSBAND_KEY_INDEX]][BIRTH_YEAR_INDEX]
        wife_name = people_dict[marriages_dict[marriage][WIFE_KEY_INDEX]][NAME_INDEX]
        wife_wedding_age = marriages_dict[marriage][WEDDING_YEAR_INDEX] - people_dict[marriages_dict[marriage][WIFE_KEY_INDEX]][BIRTH_YEAR_INDEX]
